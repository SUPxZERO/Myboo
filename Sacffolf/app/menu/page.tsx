...
export default function MenuPage() {
  return (
    <div className="min-h-screen bg-linear-to-b from-bg-primary via-rose-light to-bg-primary pb-24">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-linear-to-r from-bg-primary to-rose-light/50 backdrop-blur-lg border-b border-brand-pink/20 shadow-[0_8px_32px_rgba(255,105,180,0.1)]">
        <div className="px-6 py-4">
          ...
          <div className="flex gap-3">
            <div className="flex-1 bg-linear-to-r from-cream to-rose-light/30 rounded-full px-5 py-3 flex items-center gap-3 shadow-md border border-brand-pink/10">
            ...
            <button className="w-12 h-12 bg-linear-to-br from-brand-pink to-rose-medium rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 active:scale-95 transition-transform duration-300">
      ...
      <div className="px-6 py-6 space-y-8">
        ...
        <section>
          ...
          <SoftCard className="p-8 text-center bg-linear-to-br from-cream to-rose-light/50 border border-brand-pink/10">
