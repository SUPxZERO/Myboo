...
import { ArrowLeft, Minus, Plus, Sparkles, Trash2 } from "lucide-react"
        ...
        return (
            <CustomerLayout title="Cart 🛍️">
                <div className="flex flex-col items-center justify-center pt-24">
                    ...
                    <JellyButton onClick={() => router.visit("/menu")} className="px-8 cursor-pointer">
                        Browse Menu ✨
                    </JellyButton>
                </div>
            </CustomerLayout>
        ...
        <CustomerLayout title="Cart 🛍️">
            <div className="flex items-center justify-between mb-6">
                ...
                <button
                    ...
                    className="text-sm text-red-400 font-bold hover:text-red-500 cursor-pointer"
                >
                    Clear All
                </button>
            </div>
            ...
            <div className="space-y-4">
                    ...
                    <SoftCard key={item.id} className="p-4">
                        <div className="flex gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-lg font-bold bg-linear-to-r from-brand-pink to-rose-medium bg-clip-text text-transparent">฿{item.price}</p>
                            </div>
                            ...
                            <div className="flex flex-col items-end justify-between">
                                ...
                                <div className="flex items-center gap-2 bg-white rounded-full p-1">
                                    <button
                                        ...
                                        className="w-7 h-7 rounded-full bg-pink-50 hover:bg-pink-100 transition-colors flex items-center justify-center cursor-pointer"
                                    >
                ...
                <SoftCard className="p-5 space-y-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        />
                        <JellyButton className="px-6 cursor-pointer">Apply</JellyButton>
                    </div>
                </SoftCard>
                ...
                <SoftCard className="p-5 space-y-3">
                    ...
                    <div className="border-t-2 border-pink-100 pt-3 flex justify-between text-lg font-bold text-text-brown">
                        <span>Total</span>
                        <span className="bg-linear-to-r from-brand-pink to-rose-medium bg-clip-text text-transparent">฿{total}</span>
                    </div>
                </SoftCard>
            </div>

            <div className="fixed bottom-24 lg:bottom-12 left-0 right-0 px-6 pb-4 bg-linear-to-t from-bg-primary via-bg-primary to-transparent pt-8 lg:p-0 lg:static lg:bg-transparent lg:mt-8">
                {/* Mobile Fixed Bottom / Desktop Static */}
                <div className="max-w-7xl mx-auto">
                    <JellyButton
                        onClick={() => {
                            alert("Order placed successfully! ✨")
                        }}
                        className="w-full py-4 text-lg shadow-[0_10px_30px_rgba(255,105,180,0.3)] cursor-pointer"
                    >
