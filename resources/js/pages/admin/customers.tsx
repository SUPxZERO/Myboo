    ...
    return (
        <AdminLayout title="Customer Management">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
                <div>
                    <h2 className="text-xl font-bold text-text-brown">All Customers</h2>
                ...
                <div className="flex gap-4 overflow-x-auto w-full md:w-auto pb-2 md:pb-0">
                    <div className="px-4 py-2 bg-purple-100 rounded-xl min-w-fit">
                    ...
                    <div className="px-4 py-2 bg-yellow-100 rounded-xl min-w-fit">
                        <p className="text-xs text-text-brown/60">Gold</p>
                        <p className="text-lg font-bold text-text-brown">
                            {customers.filter((c) => c.loyaltyTier === "Gold").length}
                        </p>
                    </div>
                    <div className="px-4 py-2 bg-gray-100 rounded-xl min-w-fit">
                ...
                <div className="lg:col-span-1">
                    <SoftCard className="mb-4">
                        <div className="relative mb-4">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-white rounded-2xl border-2 border-pink-100 focus:border-brand-pink focus:outline-none text-text-brown transition-colors"
                            />
                        </div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["All", "Platinum", "Gold", "Silver"].map((tier) => (
                                        <button
                                            ...
                                            className={`px-3 py-1.5 rounded-full text-xs font-medium cursor-pointer transition-all duration-300 ${filterTier === tier
                    ...
                    <div className="space-y-3 max-h-[calc(100vh-400px)] overflow-y-auto custom-scrollbar">
                        {filteredCustomers.map((customer) => (
                            <SoftCard
                                key={customer.id}
                                className={`cursor-pointer transition-all duration-300 hover:scale-[1.02] ${selectedCustomer === customer.id ? "ring-2 ring-brand-pink" : ""
                                    }`}
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div
                                        className={`px-2 py-1 rounded-full bg-linear-to-r ${getTierColor(
                    ...
                    {selectedCustomerData ? (
                        <div className="space-y-6">
                                ...
                                <div className="flex items-start justify-between mb-6 flex-wrap gap-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div
                                                className={`inline-block px-4 py-1.5 rounded-full bg-linear-to-r ${getTierColor(
                                    ...
                                    <button className="px-4 py-2 bg-brand-pink text-white rounded-xl hover:bg-pink-600 transition-all duration-300 flex items-center gap-2 cursor-pointer">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    <div className="flex items-center gap-3 p-3 bg-pink-50 rounded-xl">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-sm font-medium text-text-brown truncate">{selectedCustomerData.email}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3 p-3 bg-pink-50 rounded-xl">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-sm font-medium text-text-brown truncate">{selectedCustomerData.phone}</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <SoftCard className="text-center hover:scale-105 transition-transform duration-300">
                                    <div className="text-green-500 w-8 h-8 mx-auto mb-2 flex items-center justify-center font-bold text-xl">$</div>
                                    ...
                                    {selectedCustomerData.recentOrders.map((order) => (
                                        ...
                                        >
                                            ...
                                            <div className="text-right">
                                                ...
                                                <button className="text-xs text-brand-pink hover:underline mt-1 cursor-pointer">
                                                    View Details
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <SoftCard className="h-full flex items-center justify-center min-h-[400px]">
